...
class InstructorControllerTest {
    ...
    void getInstructors() throws Exception {
        ...
        final boolean containsId20002 = objectMapper
                .readValue(jsonContent, ArrayList.class).get(0).toString().contains("id=20002");
        final boolean containsId20003 = objectMapper
                .readValue(jsonContent, ArrayList.class).get(1).toString().contains("id=20003");

        assertTrue(containsId20002 && containsId20003);
    }
    ...
    void getInstructorById() throws Exception {
        MvcResult result = mockMvc.perform(
                        get("/instructors/{id}", 20002).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
